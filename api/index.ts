...
import { handleGetServices } from "../src/tools/get-services.js";
import { handleAssessReadiness } from "../src/tools/assess-readiness.js";
import { handleBookConsultation } from "../src/tools/book-consultation.js";
...
// Vercel config helper
export const config = {
  api: {
    bodyParser: false, // Disable bodyParser for SSE
  },
};
